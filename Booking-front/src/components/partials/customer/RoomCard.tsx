...
//     selectedQuantities: { [roomId: number]: { [variantId: number]: number } };
//     handleSelectChange: (roomId: number, variantId: number, selectedQuantity: number) => void;
// }
//
...
//                             onChange={(e) =>
//                                 handleSelectChange(room.id, variant.id, parseInt(e.target.value))
//                             }
//                         >
