...
const HotelEditPage: React.FC = () => {
    ...
    // const { data: hotelData, refetch } = useGetHotelQuery(id as string);
    ...
    //         setValue("area", hotel.area.toString().replace('.', ','));
    //         setValue("numberOfRooms", hotel.numberOfRooms);
    ...
    //         // setValue("isArchived", hotel.isArchived ? 'true' : 'false');
    //         setValue("address.cityId", hotel.address.city.id.toString());
    //         setValue("address.latitude", hotel.address.latitude.toString().replace('.', ','));
    //         setValue("address.longitude", hotel.address.longitude.toString().replace('.', ','));
    ...
    //             });
    //             Promise.all(filePromises).then(fetchedFiles => setFiles(fetchedFiles));
    //         }
    //         // if (hotel.photos) {
    //         //     const fileUrls = hotel.photos.map(photo => `${API_URL}/images/1200_${photo.name}`);
    //         //     setFiles(fileUrls);
    //         // }
    //     }
    // }, [hotelData, setValue]);
    ...
    //         setValue("photos", Array.from(dataTransfer.files));
    //     }
