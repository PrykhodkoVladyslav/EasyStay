...
namespace EasyStay.Infrastructure.Migrations
{
    ...
    [Migration("20241110174052_added_personal_info_columns_to_Customers_table")]
    partial class added_personal_info_columns_to_Customers_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyStay.Domain.Booking", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EasyStay.Domain.BookingBedSelection", b =>
                {
            ...
            modelBuilder.Entity("EasyStay.Domain.BookingRoomVariant", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EasyStay.Domain.HotelReview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EasyStay.Domain.Booking", b =>
                {
                    b.HasOne("EasyStay.Domain.BankCard", "BankCard")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("EasyStay.Domain.BookingBedSelection", b =>
                {
                    b.HasOne("EasyStay.Domain.BookingRoomVariant", "BookingRoomVariant")
                        .WithOne("BookingBedSelection")
                        .HasForeignKey("EasyStay.Domain.BookingBedSelection", "BookingRoomVariantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EasyStay.Domain.BookingRoomVariant", b =>
                {
                    b.HasOne("EasyStay.Domain.Booking", "Booking")
            ...
            modelBuilder.Entity("EasyStay.Domain.HotelReview", b =>
                {
                    b.HasOne("EasyStay.Domain.Booking", "Booking")
                        .WithOne("HotelReview")
                        .HasForeignKey("EasyStay.Domain.HotelReview", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
